...
To cancel an order, issue an HTTP DELETE request to the API endpoint `/order/:uuid/:auth_token`. For example, to cancel the order above, issue a request like this:

```bash
curl -X DELETE $IONOSPHERE/order/409348bc-6af0-4999-b715-4136753979df/d784e322dad7ec2671086ce3ad94e05108f2501180d8228577fbec4115774750
```
